...
REQUESTS_TOTAL = Counter(
    ...
    labelnames=["repo", "model", "event_type", "cache_type"], # event_type='hit'/'miss', cache_type='exact'/'semantic'/'none'
    registry=registry
)
...
def record_request_metrics(repo: str, model: str, event_type: str, cache_type: str, tokens_input: int, tokens_output: int, cost: float):
    try:
        # Record request
